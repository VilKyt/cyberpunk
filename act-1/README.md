...
- Scene 2 — Rook's Camp *(in progress)*
...
| Thread | Hook | Status |
|---|---|---|
| The Convergence File | Arasaka knew the tomb existed | Unresolved |
| "Souls are clean" | Rook reacts — why? | Unresolved |
| Corruption in agents | Magic users can see what others can't | Slow burn |
...
By the end of Act 1 the party should have:
- [ ] Escaped the tomb and the initial Arasaka response
- [ ] Made uneasy contact with Rook and the nomads
- [ ] Seen Night City for the first time
